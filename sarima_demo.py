...
plt.savefig('./sarima_performance_comparison.png', dpi=300)
plt.close()
...
plt.savefig('./sarima_forecasting_example.png', dpi=300)
plt.close()
...
plt.savefig('./sarima_workflow.png', dpi=300)
plt.close()
...
plt.savefig('./sarima_parameter_space.png', dpi=300)
plt.close()
